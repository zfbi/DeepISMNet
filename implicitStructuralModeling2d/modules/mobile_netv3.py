...
class Block_dropout(nn.Module):
    '''expand + depthwise + pointwise'''
    def __init__(self, kernel_size, in_size, expand_size, out_size, nolinear, semodule, stride, dropout_rate=0.5):
        super(Block_dropout, self).__init__()
        self.stride = stride
        self.se = semodule
        ...
        self.bn3 = nn.Dropout(dropout_rate)
